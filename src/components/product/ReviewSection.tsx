  ...
  return (
    <section className="mt-12 pt-8 border-t border-gray-200">
      ...
      <div className="mt-8 text-center">
        <button className="inline-flex items-center justify-center px-6 py-2 border border-gray-300 rounded-md shadow-sm text-base font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-product-accent transition-colors">
          Show More Reviews
        </button>
      </div>
    </section>
